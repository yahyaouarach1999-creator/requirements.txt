...
# 2. AI CONFIG (Optimized for Free Tier gen-lang-client)
...
# 7. ADMIN UPLOAD (Clean Start Implementation)
    ...
    if pdf_file and st.sidebar.button("✨ Extract & Learn"):
        with st.spinner("AI is analyzing (Free Tier)..."):
            try:
                ...
                # Using direct model call for Free Tier stability
...
if query and not df.empty:
    ...
    st.info("The database is currently empty. Please upload an SOP in the sidebar.")
